...
# Plot
for r in listings.room_type.unique():
    plt.hist(listings[listings['room_type']==r].price, bins=50, alpha=0.5, label=r)
...
fig.suptitle('Histogram of each crime category (LSOA level)',x=0.5,y=0.05)
plt.show()
```
