...
The airbnb listing will be divided into three types: Shared room, Private room, Entire home/apt (explain why we do this classification)
The crime will be divided into ?? types: ?? (explain why we do this classification)

The descriptive statistics of each variable:

The area distribution of each variable (five histograms):

The spatial visulization of each variable (five KDE heat maps):
