...
##### Visualising relationship on a map
...
# Plot
fig = create_bivariate_map(lsoa_merge, color_sets['blue-orange'], geojson , x='crime_count', y='listing_count', ids='LSOA21CD', name='LSOA21NM', conf=conf)
fig.show()
```
